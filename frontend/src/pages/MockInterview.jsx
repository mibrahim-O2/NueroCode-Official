...
export default function MockInterview() {
        ...
        <div className="mt-6 flex flex-col gap-4">
          <div>
            ...
            <input
              ...
              className="mt-1 w-full rounded-input border border-border bg-elevated px-3 py-2 text-sm text-text-primary"
            />
          </div>
          <div>
          ...
          <button
            onClick={handleStart}
            disabled={loading}
            className="flex items-center justify-center gap-2 rounded-button bg-emerald px-4 py-2.5 text-sm text-white shadow-button hover:bg-emerald-hover disabled:opacity-50"
          >
  ...
  return (
    <div className="mx-auto max-w-lg rounded-card border border-border bg-card p-8 text-center shadow-card">
      ...
      <div className="mt-6 grid grid-cols-2 gap-4 text-left text-sm">
        ...
        <div className="col-span-2">
          ...
          <p className="font-heading text-lg text-text-primary">{result.complexity || '—'}</p>
        </div>
      </div>
      <button
        onClick={() => setStage('setup')}
        className="mt-6 rounded-button border border-border px-4 py-2.5 text-sm text-text-secondary hover:border-emerald hover:text-emerald"
      >
        Start Another
      </button>
    </div>
