...
export default function ProblemPanel({ problem }) {
  // Defensive: never let a caller passing an object without examples /
  // constraints crash the whole page (this component is rendered inside
  // pages guarded only by an ErrorBoundary).
